...
class QuestionBank
  ...
  # :correct_answer1, :correct_answer2, :correct_answer3, :correct_answer4, :correct_answer5,
  ...
  def initialize
    ...
    url = "https://opentdb.com/api.php?amount=2&category=22&difficulty=easy&type=multiple"
